            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                  Tiếp cận bệnh nhân một cách toàn diện, sử
                    dụng các phương pháp chẩn đoán tiên tiến nhất để mang lại hiệu
                    quả điều trị tối ưu.
                </p>
              </div>
            </div>
